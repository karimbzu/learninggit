...
echo "Database Name: " $db_name >> database.txt
echo "Database User: " $db_user >> database.txt
echo "Database Password: " $db_password >> database.txt
echo "Mysql root password: " $mysqlrootpass >> database.txt
